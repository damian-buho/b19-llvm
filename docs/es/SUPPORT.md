...
¡Gracias por usar **B19/LLVM**!
Este documento explica dónde conseguir ayuda y cómo formular buenas preguntas.

## Dónde preguntar

- **Informar de un fallo reproducible** — [Issues on Codeberg](https://codeberg.org/b19/llvm/issues)
- **Informar de un fallo reproducible** — [Issues on GitHub](https://github.com/damian-buho/b19-llvm/issues)
...
4. **Entorno** — sistema operativo, versión de B19/LLVM, versión del entorno de ejecución.
