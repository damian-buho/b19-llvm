...
- **Образ контейнера** `ghcr.io/damian-buho/b19/llvm-22:latest`
- **Образ контейнера** `ghcr.io/damian-buho/b19/llvm-21:latest`
- **Образ контейнера** `docker.io/damianbuho/b19-llvm-22:latest`
- **Образ контейнера** `docker.io/damianbuho/b19-llvm-21:latest`
